...
export default function Navbar() {
  return (
    <div className="flex px-28 md:px-4 h-[88px] py-6 dark:bg-gray-900 justify-between items-center max-w-[1440px] ">
      <div className="flex">
        ...
        <div className=" w-full block flex-grow lg:flex lg:items-center lg:w-auto items-center lg:space-x-4">
          <ul className="flex flex-col items-center font-medium md:flex-row md:space-x-8 md:mt-0 lg:flex-row text-[16px]">
