...
const Banner = () => {
  return (
    ...
    <section className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 mt-[80px] gap-5">
                ...
                <Cards image={image} title={'Cliqkets'} details={'This is just a placeholder for the data that will be fetched from the backend that was built by our able engineers. This code will not make it to production.'} />
                <Cards image={image} title={'Cliqkets'} details={'This is just a placeholder for the data that will be fetched from the backend that was built by our able engineers. This code will not make it to production.'} />
                <Cards image={image} title={'Cliqkets'} details={'This is just a placeholder for the data that will be fetched from the backend that was built by our able engineers. This code will not make it to production.'} />
                <Cards image={image} title={'Cliqkets'} details={'This is just a placeholder for the data that will be fetched from the backend that was built by our able engineers. This code will not make it to production.'} />
    ...
    <div className="w-[738px] mt-4 text-center text-white  text-lg font-normal">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniamt.</div>
    ...
    <section className="grid grid-cols-1 sm:grid-cols-2 mt-[102px] md:grid-cols-3 gap-5">
                ...
                <div>
                <div className="w-[83px] text-rose-500 text-2xl flex font-normal">See All</div>
                  {/* <img className="w-8 h-8 relative" src={arrow_right} alt="" /> */}
                </div>
            </section>

            <section className=" mt-[126px]">
            <div><span className="text-white  text-[56px] font-bold leading-[72px]">Look at our<br/></span><span className="text-purple-500 text-[56px] font-bold leading-[72px]">Space Events.</span></div>
            </section>
            <section className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 mt-[80px] gap-5">
